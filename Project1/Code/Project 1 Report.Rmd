...
The analytic cohort included 463 participants, 36 ($7.8\%$) reported baseline hard drug use. The baseline characteristics were largely similar between groups. Hard drug users were more likely to be current smokers ($75.0\%$ vs $34.9\%$) and had slightly lower BMI, while baseline laboratory and QOL measures were comparable. At Year 2, the majority of participants reported $\geq95\%$ adherence. Trajectory plots (Figure 1) showed expected treatment response after HAART initiation: declining viral load and increasing CD4+ T-cell counts in both groups, with stable QOL scores over two years.

**Hard Drug Use Effect:**
Table 2 summarizes frequentist and Bayesian estimates. After adjustment, baseline hard drug use was most strongly associated with lower CD4 count at Year 2 (posterior mean -153 cells/uL; 95% HPDI: -214, -95), with 100% posterior probability of both a negative and clinically meaningful (>50 cells/uL) effect, indicating strong evidence of impaired immune recovery. Physical QOL was also lower (-3.48 points; 95% HPDI: -6.22, -0.79), with 99.5% probability of a negative effect and 86% probability of exceeding the 2-point clinical threshold. In contrast, viral load (-0.01 log10; 95% HPDI: -0.41, 0.41) and mental QOL (-0.53; 95% HPDI: -4.01, 2.99) showed little evidence of clinically meaningful differences, with low probabilities of exceeding predefined thresholds. Estimates were similar with and without adherence adjustment, and frequentist and Bayesian results were closely aligned. Figure 2 shows posterior mass for CD4 and physical QOL lies predominantly below zero, whereas viral load and mental QOL show substantial overlap with the null.
